...
const Home: NextPage = () => {
  ...
  const handleSubmit = (e: any) => {
    ...
    const knownModes = ['энгийн', 'үдэшлэг', 'dirty', 'dares', 'mix'];
              ...
              <form onSubmit={handleSubmit}>
                <div>
                  <select ref={ref} id={"bank"} onChange={handleChange}>
                    ...
                    <option value="party">Үдэшлэг</option>
                    <option value="dirty">+21</option>
                    <option value="dares">Үнэн</option>
                    <option value="mix">Холимог</option>
                  </select>
                </div>
                <div>
